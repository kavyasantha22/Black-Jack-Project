...
public class Main {
    public static void main(String[] args) {
        ...
        String playerName = getName(scanner);
        getAge(playerName, scanner);
        int playerMoney = getMoney(scanner);
        System.out.println();
        if (playerMoney >= 1000){
        ...
        while (game.player.getMoney() > 0){
            ...
            int roundBet = getBet(game.player, roundCount, scanner);
            ...
            while (!game.player.isBusted() && game.player.playing){
                ...
                System.out.println("-".repeat(40));
                chooseAction(game.player, game.deck, scanner);
            }
            clearTeminal();
            System.out.println("=".repeat(40));
            System.out.println(centered + "\uD83C\uDFB2 ROUND " + roundCount + " \uD83C\uDFB2");
...
//        }
    ...
    private static int getAge(String player_name, Scanner scanner){
        int age = 0;
        while (true){
    ...
    private static int getMoney(Scanner scanner){
        while (true){
    ...
    private static int getBet(Player player, int roundCount, Scanner scanner){
        int bet;
        while (true){
    ...
    private static void chooseAction(Player player, Deck deck, Scanner scanner){
        System.out.println("\nChoose your action:");
